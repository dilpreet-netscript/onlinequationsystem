...
$(document).ready(function(){
	...
	$('#forgett-submit').click(function(){
        ...
        success: function (response) {
			$('#forgett-form').hide('fast');
            $('#setp').html(response);
            },
        error: function () {
            $('#setp').html('There was an error!');
        }
    });
	});
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="forgett-form" action="set_password.php" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="myusername" id="myusername" tabindex="1" class="form-control" placeholder="Enter Username" value="">
									</div>
									<!--div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login-submit" id="forgett-submit" tabindex="4" class="form-control btn btn-login" value="Forgett">
											</div>
										</div>
									</div>
									<!--div class="form-group">
