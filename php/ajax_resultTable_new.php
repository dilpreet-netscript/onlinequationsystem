...
echo "<table class='table table-hover table-striped' id='tbl'>";
echo "<thead>";
echo "<tr class='info'><td>Items</t><td>Price</td><!--td>Quanity</td--><td>Quantity</td><td style='margin-left:100px;' align='center'>Subtotal</td><td>Action</td></tr></thead>";
echo "<tbody>";
$totalprice = 0;
...
$result = mysql_query($query) or die(mysql_error());
 ...
 while($r = mysql_fetch_row($result))
 {
	 ...
	 echo "<tr class='table-success' id='dr'><td id='itm'><input type='hidden' id='dd' value=".$r[0].">"."<span id='itmname'>" . $r[3] . "</span>"."</td><td class='two' id='aaa'>" . $r[8] . "</td><!--td><span class='glyphicon glyphicon-shopping-cart same-text'><p class='cart-item'></p></span></td--><td><!--img src='../images/minus.png' height='20' width='20' id='minusvalue' style='float:left;'/--><input type='text' name='quantity' class='qnt' size='4' minlength='1' maxlength='3' value='1'><!--img src='../images/plus.png' style='float:right;' height='20' width='20' id='plusvalue'/--></td> <td class='updateprice'>". $r[8] ."</td><td align='center'><button class=' glyphicon glyphicon-trash btn-danger btnDelete' style='margin-left:50px;'></button></td></tr>";
...
<button type="submit" class="btn btn-success submitaction2" id="onclick"><span class="glyphicon glyphicon-shopping-cart"></span> Checkout</button>
</div>
</div>
<!--/div-->
