                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
							...
							?>
								...
								<?php }  } ?>
								<tr>
								<td colspan='4' class='text-right' id='sub_total'><b>Subtotal:</b>	</td></tr>
								
								<tr>
								<td colspan='4' class='text-right' id="tx"><b>Tax:</b>	2.25</td></tr>
								<tr>
								<td colspan='4' class='text-right' id="tx"><b>Discount:</b>	<!--input type="text" name="updatediscount" id="discount" size="5" value="" placeholder="Discount"--><?php echo $dis; ?></td></tr>
								<tr>
