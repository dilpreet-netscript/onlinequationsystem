...
$('#productForm').submit(function(e){
	...
	alert('submit');
	/*$.post("../php/addproduct.php", data: $(this).serialize(), // it will serialize the form data
...
<form method="post" class="form-horizontal" id="productForm" autocomplete="off">
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Name:</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" name="name" id="name1" placeholder="Enter product name">
